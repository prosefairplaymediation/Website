...
- **Contact page** at `/contact` — two-column header (text on left, portrait `New_Contact.jpg` on right). Email + phone (`(561) 941-0896`) + eFax (`561-652-9345`) cards, secondary booking CTA.
